...
def main():
    ...
    for label_id, label in enumerate(labels):
        print("{:>30} ({:2d}): {:<40} has instances: {}".format(
    ...
    colored_instance_label_array = apply_color_map(
        instance_label_array, labels)
    ...
    for segment_id in example_segments:
        segment_info = example_segments[segment_id]
