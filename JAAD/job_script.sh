#!/bin/bash
#SBATCH -J jaad_scene    # Job name
#SBATCH -o jaad_scene.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e jaad_scene.o%j    # Name of stderr output file
...
python detector_global_cues.py  /scratch/datasets/JAAD_clips/ traffic_scene_elements.txt /scratch/datasets/JAAD_dataset